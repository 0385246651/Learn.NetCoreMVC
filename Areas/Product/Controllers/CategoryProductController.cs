...
namespace App.Areas.Product.Controllers
{
  ...
  public class CategoryProductController : Controller
  {
    ...
    {
      ModelState.Remove(nameof(CategoryProduct.ParentCategory));
      ModelState.Remove(nameof(CategoryProduct.CategoryChildren));
    ...
    // GET: categoryproduct/Category/Edit/5
    ...
    public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Slug,ParentCategoryId")] CategoryProduct category)
    {
      ...
      {
        var childCates =
                    (from c in _context.CategoryProduct select c)
                    .Include(c => c.CategoryChildren)
                    .ToList()
